export default function TOSPage() {
  return (
    <main>
      ...
      <p>Welcome to Champagne!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Champagne's Website, located at delvaze.xyz.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Champagne if you do not agree to take
      ...
      <p>
        We employ the use of cookies. By accessing Champagne, you agreed to use
        cookies in agreement with the Champagne's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, Champagne and/or its licensors own the
        intellectual property rights for all material on Champagne. All
        intellectual property rights are reserved. You may access this from
        Champagne for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Champagne</li>
        <li>Sell, rent or sub-license material from Champagne</li>
        <li>Reproduce, duplicate or copy material from Champagne</li>
        <li>Redistribute content from Champagne</li>
      </ul>
      ...
      <p>
        ...
        Champagne does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Champagne,its agents and/or affiliates. Comments reflect the
        views and opinions of the person who post their views and opinions. To
        the extent permitted by applicable laws, Champagne shall not be liable
      ...
      <p>
        Champagne reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Champagne a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Champagne; and (d) the link is
      ...
      <p>
        ...
        e-mail to Champagne. Please include your name, your organization name,
      ...
      <p>
        No use of Champagne's logo or other artwork will be allowed for linking
